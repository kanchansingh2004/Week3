...
//Create a TextEditor class with the following methods:
public class TextEditor {
    // Fields to maintain the current state and history size
    private Node currentState;
    private int size;
    private final int MAX_HISTORY_SIZE;

    // create a Node class to store the text state
    static class Node {
        String text;   
        Node prev;     
        Node next;    
    ...
    // Undo functionality to move to the previous state
    public void undo() {
    ...
    // Redo functionality to move to the next state
    public void redo() {
