...
// TaskScheduler class to implement the Task Scheduler System
public class TaskScheduler {
    //create a circular linked list to store the tasks
    static class Node {
        int taskId;
        String taskName;
        int priority;
        ...
        // Create a constructor to initialize the task details
