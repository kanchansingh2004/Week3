...
// LibraryManagement class to manage the library
public class LibraryManagement {
    // create a Node class to represent a book
    static class Node {
        String bookTitle;
        String author;
        String genre;
        ...
        // create a constructor to initialize the book details
    ...
    // create head and tail nodes to represent the start and end of the library
    private Node head;
    private Node tail;
